...
const translations = {
  es: {
    ...
    bienvenida:
      "Bienvenido a mi portafolio, aqui podras ver mis proyectos, tecnologias y experiencia laboral.",
    ...
    proyectos: [
      {
        ...
        descripcion:
          "Generador de comandos .NET para crear proyectos a partir de plantillas. Desarrollado en HTML, CSS y JS puro.",
        boton: "Ver más",
        link: "https://yunierayala2000.github.io/PORTFOLIO-YUN_DEV/Pages/Proyect1/commandGeneratNet.html",
      },
      {
        titulo: "Generador de texto a voz",
        img: "Assets/img/P2.png",
        descripcion:
          "Generador de texto a voz en tiempo real con ajustes de voz.",
        boton: "Ver más",
        link: "https://yunierayala2000.github.io/Text-A-Voz/",
      },
      {
        titulo: "E-commerce API",
        img: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=400&q=80",
        descripcion:
          "API RESTful para tienda online, desarrollada en Node.js y Express, con integración de pagos y panel de administración.",
        boton: "Ver más",
      },
      {
        ...
        img: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=400&q=80",
        descripcion:
          "Aplicación web para gestión de tareas con drag & drop, notificaciones y sincronización en la nube. Stack: React, Firebase.",
        boton: "Ver más",
      },
    ],
  ...
  en: {
    ...
    title: "Hi! I'm Junier",
    bienvenida:
      "Welcome to my portfolio, here you can see my projects, technologies, and work experience.",
    ...
    proyectos: [
      ...
      {
        titulo: "Text to Speech Generator",
        img: "Assets/img/P2.png",
        descripcion:
      ...
      },
      {
        ...
        descripcion:
          "RESTful API for online store, built with Node.js and Express, with payment integration and admin panel.",
        boton: "See more",
      },
      {
        titulo: "Task Manager",
        img: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80",
        descripcion:
          "Web app for task management with drag & drop, notifications, and cloud sync. Stack: React, Firebase.",
        boton: "See more",
      },
    ],
...
function setLanguage(lang) {
  ...
  // Navegación
  document.querySelector('a[href="#inicio"] span:last-child').textContent =
    t.nav.inicio;
  document.querySelector('a[href="#sobre-mi"] span:last-child').textContent =
    t.nav.sobreMi;
  document.querySelector('a[href="#proyectos"] span:last-child').textContent =
    t.nav.proyectos;
  document.querySelector('a[href="#tecnologias"] span:last-child').textContent =
    t.nav.tecnologias;
  ...
  if (proyectosCont) {
    proyectosCont.innerHTML = t.proyectos
      .map(
        (proj) => `
      <div class="proyecto">
  ...
  document
    ...
    .classList.toggle("selected", lang === "es");
  document
    .getElementById("lang-en")
    .classList.toggle("selected", lang === "en");
